...
ActiveRecord::Schema.define(version: 20190322225259) do
  ...
  create_table "answerd_questions", force: :cascade do |t|
    ...
    t.index ["question_id"], name: "index_answerd_questions_on_question_id", using: :btree
    t.index ["user_id"], name: "index_answerd_questions_on_user_id", using: :btree
  end
  ...
  add_foreign_key "answerd_questions", "users"
